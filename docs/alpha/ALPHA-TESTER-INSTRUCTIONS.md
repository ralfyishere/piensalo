...
## Setup
1. Clone the public repository: `git clone https://github.com/ralfyishere/piensalo.git`
...
## Returning results
Open a GitHub Issue with the filled JSON (label: alpha-report), or use the
result-submission guide in SUBMIT-RESULTS.md.
