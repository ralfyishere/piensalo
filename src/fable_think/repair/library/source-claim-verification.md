...
description: "Trace each load-bearing claim to its primary source before believing it — especially self-labeled causes in error messages, logs, vendor explanations, and second-hand summaries."
---
...
**Evidence status:** designed — procedure derived from documented symptom-label-distrust (evidence-backed) and plausible-and-stop failure modes; this micro-skill itself has no direct experimental test yet.
