...
High-stakes prose with a hard length limit where every number must be defensible: exactly the trigger for fable-write. The skill fires and works the pipeline:
