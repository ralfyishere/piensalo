...
An unpowered actuation mechanism must be designed to quantitative requirements: exactly the trigger for fable-invent. The skill fires and works the pipeline:
