...
**Symptom (verbatim):** "GET /items?page=2 sometimes repeats the last item of page 1." An intermittent, user-visible bug - exactly the profile fable-build exists for.
