...
**Candidate:** a PR claiming "fixed the unstable sort in the leaderboard; all tests pass." A finished artifact about to be trusted - exactly the profile piensalo-verify exists for.
