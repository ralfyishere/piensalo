...
The failure-mode catalog: failure signatures commonly observed in weaker models, ordered most-relevant-first for this skill. Before finalizing, scan the draft against each signature; on a hit, apply the repair contract(s) in references/contracts.md.
